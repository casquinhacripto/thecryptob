...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center relative min-h-[calc(100vh-200px)] pt-24">
      {/* Enhanced Multi-layer Radial Background Gradient for Depth */}
      <div className="fixed inset-0 -z-10 bg-gradient-to-b from-[#111] via-[#000] to-[#000]"></div>
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_center,#0E0E10_40%,#060606_100%)]"></div>
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,rgba(0,212,242,0.08)_0%,transparent_50%)]"></div>
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(ellipse_at_bottom,rgba(255,165,0,0.04)_0%,transparent_60%)]"></div>
